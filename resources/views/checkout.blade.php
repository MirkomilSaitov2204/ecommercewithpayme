...
<div class="container">
    ...
    <div class="checkout-section">
            ...
            <form action="{{ route('checkout.store') }}" id="payment-form" method="POST">
                ...
                <div class="mt-32">
                    ...
                    <form method="post" id="paypal-payment-form" action="https://laravelecommerceexample.ca/paypal-checkout">
                        <input type="hidden" name="_token" value="9f7FOGEc2j0TcvCTxHqRMFHq1NFUFc8lBy2klRNi">
                            <section>
        ...
        <div class="checkout-table-container">
            ...
            @if (!session()->has('coupon'))
                <div class="text-center"><a href="#" class="have-code">Have a code</a>
                </div>
            <div class="have-code-container">
                    <form action="{{ route('coupon.store') }}" method="POST">
                        {{ csrf_field() }}
                            <div class="text-center">
                                    <input type="text" name="coupon_code" id="coupon_code" style="padding:3.8%">
...
var stripe = Stripe('pk_test_YZqph0CQJexJf25TsNeigLXt009ta6Vig4');
