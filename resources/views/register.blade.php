...
<!-- Mirrored from laravelecommerceexample.ca/register by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 13 Jan 2020 08:28:46 GMT -->
...
<head>
        ...
        <!-- CSRF Token -->
        <meta name="csrf-token" content="TJvkCuoDOkFMDFqOgR0lGuZLAXAPLnANstqJ6E6m">

        <title>Laravel Ecommerce | Sign Up for an Account</title>
    ...
    <div class="auth-pages">
        <div>
            ...
            <form method="POST" action="https://laravelecommerceexample.ca/register">
                <input type="hidden" name="_token" value="TJvkCuoDOkFMDFqOgR0lGuZLAXAPLnANstqJ6E6m">
